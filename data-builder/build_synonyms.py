...
def build_synonyms() -> None:
    ...
    add(data, 'Action Boost Charges', ['Action Boost Enhancement', 'Action Boosts'])
    add(data, 'Arcane Casting Dexterity', ['Lesser Arcane Casting Dexterity', 'Greater Arcane Casting Dexterity'])
    add(data, 'Armor Class', ['AC', 'Armor', 'Armor Bonus', 'Natural Armor', 'Natural Armor Bonus', 'Protection', 'Rough Hide', 'Shield', 'Shield Armor Class'])
    ...
    add(data, 'False Life (%)', ['Conditioning (%)'])
    add(data, 'Force Spell Crit Damage', ['Force and Physical Spell Crit Damage'])
    add(data, 'Fortitude Save', ['Fortitude saves'])
    add(data, 'Greater Dragonmark Charges', ['Greater Dragonmark Enhancement'])
    add(data, 'Healing Lore', ['Positive Spell Crit Chance', 'Positive Spellcrit Chance'])
    add(data, 'Lesser Dragonmark Charges', ['Lesser Dragonmark Enhancement', 'Lesser Dragonmarks'])
    ...
    add(data, 'Speed', ['Striding', 'movement speed'])
    add(data, 'Physical Sheltering', ['Physical Resistance Rating', 'PRR'])
    add(data, 'Magical Efficiency', ['Power Store'])
    ...
    add(data, 'Rage Charges', ['Anger', 'Minor Anger', 'Rages'])
    add(data, 'Reflex Save', ['Reflex saves'])
    add(data, 'Sheltering', ['Physical and Magical Resistance Rating'])
    add(data, 'Smite Evil Charges', ['Extra Smites'])
    ...
    add(data, 'Well Rounded', ['Ability stats', 'All Ability Scores', 'all Abilities', 'all Ability Scores', 'all of your Ability Scores', 'each Ability Score', 'Well-Rounded'])

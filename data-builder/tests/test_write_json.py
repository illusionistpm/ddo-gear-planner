...
def test_write_json_writes_stripped_asset_and_provenance_copy(monkeypatch, tmp_path):
    temp_root = tmp_path / 'write-json'
...
def test_read_json_prefers_provenance_copy_when_enabled(monkeypatch, tmp_path):
    temp_root = tmp_path / 'read-json'
    asset_path = temp_root / 'assets' / 'sample.json'
    provenance_path = temp_root / 'assets' / 'provenance' / 'sample.json'
